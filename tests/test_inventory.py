...
HoleStrategy = gui.inventory.HoleStrategy
CoolantMode = gui.inventory.CoolantMode
EntryMode = gui.inventory.EntryMode
...
class InventoryTest(unittest.TestCase):
    ...
    def testPropagation(self):
        ...
        self.checkPropagationForPreset("2mm HSS", "Wood-untested", attr_values=[("rpm", 3), ("vfeed", 30), ("maxdoc", 1), ('coolant_mode', CoolantMode.OFF)])
        ...
        self.checkPropagationForPreset("cheapo 2F 3.2/15", "Wood-roughing",
            attr_values=[("rpm", 3), ("vfeed", 30), ("hfeed", 30), ("maxdoc", 1), ("offset", 0.1), ("stepover", 0.55), ("direction", MillDirection.CLIMB),
                ("extra_width", 0.1), ("trc_rate", 0.1), ("pocket_strategy", PocketStrategy.HSM_PEEL_ZIGZAG), ("hole_strategy", HoleStrategy.RADIAL_AXIAL), ("axis_angle", 45), ('min_eh_diameter', 30), ('max_eh_diameter', 30), ('entry_mode', EntryMode.PREFER_HELIX), ('roughing_offset', 0.05), ('coolant_mode', CoolantMode.OFF)])
    ...
    def checkStdCutters(self, inventory):
        ...
        self.checkPreset(inventory, "cheapo 2F 3.2/15", "Wood-roughing",
            ...
            direction=MillDirection.CONVENTIONAL, pocket_strategy=PocketStrategy.CONTOUR_PARALLEL, hole_strategy=HoleStrategy.AXIAL_RADIAL, extra_width=0, trc_rate=0, axis_angle=0, min_eh_diameter=0.2, max_eh_diameter=0.5)
