...
class DocumentTest(unittest.TestCase):
    ...
    def testAddCutter(self):
        ...
        self.verifyCutter(cutter, "added cutter: 3F \u23004.0 L15 HSS end mill")
        cutter = gui.inventory.DrillBitCutter.new(None, "added drill bit", gui.inventory.CutterMaterial.HSS, 3, 33)
        self.verifyCutter(cutter, "added drill bit: 3mm HSS drill bit, L=33mm")
