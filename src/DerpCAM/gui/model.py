...
class DocumentModel(QObject):
    ...
    def load(self, data):
        ...
        if 'tool' in data:
            ...
            std_tool = milling_tool.standard_tool(prj_cutter.diameter, prj_cutter, prj_cutter.flutes, material, milling_tool.carbide_uncoated, rpm=tool['rpm']).clone_with_overrides(
