...
class PresetDerivedAttributes(object):
    ...
    attrs_endmill = [
        ...
        PresetDerivedAttributeItem('hole_strategy', def_value=inventory.HoleStrategy.AXIAL_RADIAL),
...
class ToolPresetTreeItem(CAMTreeItem):
    ...
    prop_pocket_strategy = EnumEditableProperty("Pocket strategy", "pocket_strategy", inventory.PocketStrategy, allow_none=True)
    prop_hole_strategy = EnumEditableProperty("Hole strategy", "hole_strategy", inventory.HoleStrategy, allow_none=True)
    ...
    def properties_endmill(klass):
        return [klass.prop_name, klass.prop_doc, klass.prop_hfeed, klass.prop_vfeed, klass.prop_offset, klass.prop_roughing_offset, klass.prop_stepover, klass.prop_direction, klass.prop_rpm, klass.prop_surf_speed, klass.prop_chipload, klass.prop_extra_width, klass.prop_trc_rate, klass.prop_pocket_strategy, klass.prop_hole_strategy, klass.prop_axis_angle, klass.prop_min_eh_diameter, klass.prop_max_eh_diameter, klass.prop_entry_mode, klass.prop_coolant_mode]
    @classmethod
    ...
    def setPropertyValue(self, name, value):
        ...
        if name == 'doc':
            ...
            assert False, "Unknown attribute: " + repr(name)
        if name in ['roughing_offset', 'offset', 'stepover', 'direction', 'extra_width', 'trc_rate', 'pocket_strategy', 'hole_strategy', 'axis_angle', 'min_eh_diameter', 'max_eh_diameter', 'entry_mode']:
